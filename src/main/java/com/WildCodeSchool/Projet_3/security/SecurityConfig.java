  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        .authorizeHttpRequests((requests) -> requests
            ...
            .requestMatchers("/register", "/login","/send-email", "/user/{id}","admin/users","/admin/users/{id}","/account","/users/{id}/account/dispo/{dispo}", "/admin/users/{id}/role","/users/{id}/account/avatar/{avatar}","/users/{id}/account/color/{color}").permitAll()
