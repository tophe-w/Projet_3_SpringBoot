  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        .authorizeHttpRequests((requests) -> requests
            ...
            .requestMatchers("/register", "/login","/send-email", "/user/{id}","admin/users","/account", "/admin/users/{id}/role","/users/{id}/account/avatar/assets/avatar/{avatar}","/users/{id}/account/color/{color}").permitAll()
