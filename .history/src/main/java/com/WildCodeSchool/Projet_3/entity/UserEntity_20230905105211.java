...
public class UserEntity {
  ...
  private Role role;
    ...
    public UserEntity(String name, String password, boolean is_connected, String email, Role role,Date birthday,String firstname, String username, 
        ...
        this.avatar = c:\Users\8511384E\Documents\Dev\Projet_3_SpringBoot\src\main\resources\avatar\AvatarH1.png;         //chemin avec son.png en enregistré dans le dossier ressources
        this.color = color;
