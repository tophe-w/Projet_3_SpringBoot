...
public class UserService {
  ...
  public UserDto register(UserDto user) {
    ...
    UserEntity newUser = new UserEntity(user.getName(),hashedpassword,false,user.getEmail(),userRole,user.getBirthday(),user.getFirstname(),user.getUsername(),"assets/avatar/AvatarH1.png","",false);
