...
@GetMapping("/admin/users")
    ...
    @PutMapping("/users/{id}/account/avatar/")
    @ResponseBody
    public ResponseEntity<?> updateUserAvatarAccount(@PathVariable Integer id, @RequestBody UserEntity user) {
        ...
        if (avatarUpdate == null) {
          ...
          if(avatarUpdate.getAvatar() != user.getAvatar()){
              avatarUpdate.setAvatar(user.setAvatar(null);avatar);
              userRepository.save(avatarUpdate);
              System.out.println("avatarUpdate = " + avatar);
          }
